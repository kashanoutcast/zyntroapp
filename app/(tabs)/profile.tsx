...
import { Ionicons, MaterialIcons, FontAwesome, FontAwesome5, Entypo, Feather } from '@expo/vector-icons';
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.profileHeader}>
          ...
          />
          <Text style={styles.profileName}>Kashan Akram</Text>
          <Text style={styles.profileTitle}>Sr. Project Manager</Text>
        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={styles.infoItem}>
            ...
            <Text style={styles.infoText}>Product Manager</Text>
          </View>
          
          <View style={styles.infoItem}>
            <View style={styles.infoIconContainer}>
              <FontAwesome5 name="users" size={14} color="#333" />
            </View>
            <Text style={styles.infoText}>Product Management</Text>
          </View>
          
          <View style={styles.infoItem}>
            <View style={styles.infoIconContainer}>
              <FontAwesome name="google" size={14} color="#333" />
            </View>
          ...
          <View style={styles.infoItem}>
            <View style={styles.infoIconContainer}>
              <Entypo name="location-pin" size={14} color="#333" />
            </View>
            <Text style={styles.infoText}>Brooklyn, New York, US</Text>
          </View>
          ...
          <View style={styles.infoItem}>
            ...
            <Text style={styles.infoText}>kashan@gmail.com</Text>
          </View>
          ...
          <View style={styles.infoItem}>
            ...
            <Text style={styles.infoText}>+92 313-4219483</Text>
          </View>
        </View>
        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={styles.projectItem}>
            ...
            <View style={styles.progressBarContainer}>
              <View style={[styles.progressBar, { width: '65%', backgroundColor: '#4b43c9' }]} />
